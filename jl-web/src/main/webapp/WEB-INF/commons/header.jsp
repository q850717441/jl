...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jl.com/index.html" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/jt-logo.png" width="270" height="60" alt="京淘"></a></div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<dt class="ld"><a href="http://www.jl.com/cart/show.html" id="settleup-url">去购物车结算</a> <b></b> </dt>
<!-- 				<dd>
					<div class="prompt">
						<div class="loading-style1"><b></b>加载中，请稍候...</div>
					</div>
	...
	<div class="w">
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					<li class="fore1" id="nav-home" clstag="homepage|keycount|home2013|07a"><a href="http://www.jl.com/">首页</a></li>
