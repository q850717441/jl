...
<script type="text/javascript">
    ...
    function addToFavorite() {
        var a = "http://www.jl.com/";
        var b = "精灵商城-网购上精灵，省钱又放心";
        if (document.all) {
...
<div class="w" id="logo">
    <div>
        <a href="http://www.jl.com/">
            <img src="/images/jt-logo.png" alt="精灵商城" width="170" height="60"/>
        </a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://www.jl.com/user/login.html"
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《精灵用户注册协议》</a></label>
                        <span class="clr"></span>
